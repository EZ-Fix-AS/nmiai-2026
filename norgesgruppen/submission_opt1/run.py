...
OPT1: 3-Model WBF — Guide-optimized params for dense retail shelf
...
def main():
    ...
    # Weights proportional to val mAP: phase1=0.735, phase2=0.742, v3=0.753
    ...
    print(f"OK: {len(all_preds)} predictions for {len(images)} images (OPT1: guide-optimized)")
