...
3-Model WBF — identical to 0.8993 baseline EXCEPT iou_thr=0.43 (was 0.5)
...
def main():
    ...
    models = [
        ...
        (YOLO(str(model_dir / 'phase2_1280.onnx'), task='detect'), 1280, 1.5),
        (YOLO(str(model_dir / 'v3_1280.onnx'), task='detect'), 1280, 1.5),
    ]
    ...
    print(f"OK: {len(all_preds)} preds for {len(images)} images (3m iou_wbf=0.43)")
