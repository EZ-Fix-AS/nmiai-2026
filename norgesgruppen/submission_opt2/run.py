...
OPT2: 3-Model WBF — iou_thr=0.40 (even denser retail)
  conf=0.001, skip_box_thr=0.0001, iou_thr=0.40,
...
def main():
    ...
    print(f"OK: {len(all_preds)} predictions for {len(images)} images (OPT2: iou_thr=0.40)")
